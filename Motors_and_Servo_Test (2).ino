...
#define INa CHANGEME  //Channel A direction 
#define INb CHANGEME  //Channel A direction 
#define INc CHANGEME  //Channel B direction 
#define INd CHANGEME  //Channel B direction 
